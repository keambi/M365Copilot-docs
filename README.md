...
**What's in here**
- **This handout** — what you're reading: document limits, a prompt formula, seven ready-to-use prompts, and two practice exercises.
- **`Sample-Doc-1-Investigation-Memorandum.docx`** — a ~10-page Word document to practice on.
- **`Sample-Doc-2-Decision-and-Order.pdf`** — a ~10-page PDF to practice the PDF workflow.

*(The sample files describe the same fictional scenario, so you can also practice comparing documents.)*

**What you need**
- Access to **Microsoft 365 Copilot** at work or school (the licensed version). You'll use it in one of two places:
  - **Copilot in Word** — open a document in Word and use the Copilot pane.
  - **Copilot Chat** — the chat experience where you attach or reference a file.

**Get started in four steps**
1. **Download** a sample file above (or use one of your own documents).
2. **Open it** in Word, *or* attach/reference it in Copilot Chat.
3. **Copy a prompt** from Section 5, paste it into Copilot, and edit the **[bracketed]** parts.
4. **Check the answer** against the document — ask Copilot to quote the sentence it used (see the verification habit in Section 7).

> 💡 **New to this?** Start with **Practice A** in Section 6 — it walks you through summarizing a document and pulling out the action items, step by step.
