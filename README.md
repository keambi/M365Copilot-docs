...
How Copilot "sees" your documents (a 30-second mental model)
Document limits in Microsoft 365 Copilot — with official Microsoft sources
What the limits mean in practice
The prompt formula: Goal · Context · Source · Expectations
Seven ready-to-use prompts you can copy, paste, and adapt
Two practice workflows to try on your own documents
A quick-reference cheat sheet
Sources (official Microsoft documentation)
---
...
Open a long document (10+ pages works well).
Run Prompt 1 to get a one-page summary. Time yourself against how long a full read would take.
Run Prompt 2 to pull every action item and deadline into a table.
Verify: pick one action item and confirm it actually appears where Copilot says it does.
...
Use the same long document. Run Prompt 3 with a specific question, and ask Copilot to quote the sentence it relied on.
Confirm the quote really appears in the file.
Now add a second related document (reference both). Run Prompt 5 to compare how the two documents treat the same topic, with each point attributed to its source.
...
How reference and document lengths affect Copilot responses — Microsoft Support.
...
Expanding reference capabilities with Microsoft 365 Copilot in Word — Microsoft 365 Message Center (MC1060858).
(Reference up to ~1.5M words / 3,000 pages; up to 20 referenced items; folder referencing uses the 10 most recent files.)
File formats supported by Microsoft 365 Copilot — Microsoft Support.
...
File upload in Microsoft Copilot — Microsoft Support (consumer Copilot; shown to contrast with Microsoft 365 Copilot for work).
